...
static int	set_size_array(long n)
{
	int		nb;
...
static void	set_array(char *nbr, long n, int is_negative, int size_array)
{
...
**
** DESCRIPTION:
**	ft_ltoa() convertit une valeur de type long en chaine de caractere
